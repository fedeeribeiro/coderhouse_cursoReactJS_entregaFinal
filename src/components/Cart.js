...
const Cart = () => {
    const { cartList, deleteThis, deleteAll, orderTotalPrice } = useContext(CartContext);
                                    ...
                                    <MDBCardBody className="p-4">
                                        <MDBRow className="justify-content-between align-items-center">
                                            ...
                                            <MDBCol md="3" lg="3" xl="2"
                                                ...
                                                <p>{item.qty} un. a ${item.unit_price}</p>
                                            </MDBCol>
                                            ...
                                            <MDBCol md="1" lg="1" xl="1" className="text-end">
                                                    <button onClick={() => deleteThis(item.id)} style={{border: 'none', backgroundColor: 'transparent'}}>
